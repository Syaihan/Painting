...
<!-- Skrip Global Pencegah Double Click / Double Submit pada Semua Form -->
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            // Otomatis menargetkan SEMUA form di seluruh halaman aplikasi
            ...
            forms.forEach(form => {
                form.addEventListener('submit', function (e) {
                    ...
                    if (submitBtn) {
                        // Jika tombol sudah diklik sebelumnya, cegah pengiriman ganda
                        if (submitBtn.dataset.submitted === 'true') {
                            e.preventDefault();
                            return;
                        }
                        
                        // Tandai tombol sebagai sudah disubmit
                        submitBtn.dataset.submitted = 'true';
                        submitBtn.disabled = true;
                        submitBtn.classList.add('opacity-75', 'cursor-not-allowed');
                        
                        // Jika elemen tombol berupa <button>
                        ...
                        // Jika elemen tombol berupa <input type="submit">
