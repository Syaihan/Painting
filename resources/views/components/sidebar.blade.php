<aside id="sidebar" 
       ...
       class="bg-slate-700 text-white flex flex-col min-h-screen shadow-xl transition-all duration-300  relative">
    ...
    <div class="p-1 bg-slate-800 text-center font-black text-lg tracking-wider border-b border-slate-600 flex items-center justify-center overflow-hidden">
        <a href="/dashboard" class="flex items-center gap-3 px-3 py-2.5 rounded hover:bg-slate-800 text-white font-semibold transition">
    ...
    <!-- Navigation Menu -->
    <nav class="flex-1 p-3 space-y-2 text-sm overflow-y-auto" x-data="{openDashboard: false, openScan: false, openMaterial: false }">
        <!-- Menu Dashboard -->
        <div>
            ...
            <div x-show="isOpen && openDashboard" x-cloak class="pl-9 pr-2 py-1 space-y-1 text-xs font-medium text-blue-200">
                <a href="/dashboard/coating" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Dashboard Coating</a>
                <a href="/dashboard/sealing" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Dashboard Sealing</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div x-show="isOpen && openScan" x-cloak class="pl-9 pr-2 py-1 space-y-1 text-xs font-medium text-blue-200">
                <a href="/scan/console" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Scan Console</a>
                <a href="/scan/stock-card" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Stock Card</a>
                <a href="/scan/stock-in" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Stock In</a>
                <a href="/scan/nglog" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">NG Log</a>
                <a href="#" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Riwayat Stock</a>
                <a href="/master-sealing" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Master Part</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div x-show="isOpen && openMaterial" x-cloak class="pl-9 pr-2 py-1 space-y-1 text-xs font-medium text-blue-200">
                <a href="#" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Powder</a>
                <a href="#" wire:navigate class="block px-2 py-1.5 rounded hover:bg-slate-800 hover:text-white transition">Bonderite</a>
            </div>
        </div>
